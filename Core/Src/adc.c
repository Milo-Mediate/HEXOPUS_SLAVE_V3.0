...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PF12     ------> ADC1_INP6
    */
    GPIO_InitStruct.Pin = CAP_SEN_6_Pin|DUM_SEN_6_Pin|CAP_SEN_4_Pin|DUM_SEN_4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = DUM_SEN_1_Pin|CAP_SEN_1_Pin|CAP_SEN_3_Pin|DUM_SEN_3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = DUM_SEN_5_Pin|CAP_SEN_5_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = CAP_SEN_2_Pin|DUM_SEN_2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  */
    ...
    PF14     ------> ADC2_INP6
    */
    GPIO_InitStruct.Pin = DSP_SEN_2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(DSP_SEN_2_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = DSP_SEN_3_Pin|DSP_SEN_4_Pin|DSP_SEN_5_Pin|DSP_SEN_6_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = DSP_SEN_1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(DSP_SEN_1_GPIO_Port, &GPIO_InitStruct);
    ...
    NodeConfig.DataHandlingConfig.DataExchange = DMA_EXCHANGE_NONE;
    NodeConfig.DataHandlingConfig.DataAlignment = DMA_DATA_RIGHTALIGN_ZEROPADDED;
    if (HAL_DMAEx_List_BuildNode(&NodeConfig, &Node_GPDMA2_Channel7) != HAL_OK)
    {
      Error_Handler();
    }

    if (HAL_DMAEx_List_InsertNode(&List_GPDMA2_Channel7, NULL, &Node_GPDMA2_Channel7) != HAL_OK)
    {
      Error_Handler();
    }

    if (HAL_DMAEx_List_SetCircularMode(&List_GPDMA2_Channel7) != HAL_OK)
    {
      Error_Handler();
    }
    ...
    handle_GPDMA2_Channel7.InitLinkedList.TransferEventMode = DMA_TCEM_BLOCK_TRANSFER;
    handle_GPDMA2_Channel7.InitLinkedList.LinkedListMode = DMA_LINKEDLIST_CIRCULAR;
    if (HAL_DMAEx_List_Init(&handle_GPDMA2_Channel7) != HAL_OK)
    {
      Error_Handler();
    }

    if (HAL_DMAEx_List_LinkQ(&handle_GPDMA2_Channel7, &List_GPDMA2_Channel7) != HAL_OK)
    {
      Error_Handler();
    }

    __HAL_LINKDMA(adcHandle, DMA_Handle, handle_GPDMA2_Channel7);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PF12     ------> ADC1_INP6
    */
    HAL_GPIO_DeInit(GPIOC, CAP_SEN_6_Pin|DUM_SEN_6_Pin|CAP_SEN_4_Pin|DUM_SEN_4_Pin);

    HAL_GPIO_DeInit(GPIOA, DUM_SEN_1_Pin|CAP_SEN_1_Pin|CAP_SEN_3_Pin|DUM_SEN_3_Pin);

    HAL_GPIO_DeInit(GPIOB, DUM_SEN_5_Pin|CAP_SEN_5_Pin);

    HAL_GPIO_DeInit(GPIOF, CAP_SEN_2_Pin|DUM_SEN_2_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PF14     ------> ADC2_INP6
    */
    HAL_GPIO_DeInit(DSP_SEN_2_GPIO_Port, DSP_SEN_2_Pin);

    HAL_GPIO_DeInit(GPIOA, DSP_SEN_3_Pin|DSP_SEN_4_Pin|DSP_SEN_5_Pin|DSP_SEN_6_Pin);

    HAL_GPIO_DeInit(DSP_SEN_1_GPIO_Port, DSP_SEN_1_Pin);
